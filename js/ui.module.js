export class Ui {
  ...
  displayGames(data) {
    ...
    document.getElementById("gameData").innerHTML = gamesCartona;
  }
  desplayDetails(data) {
    let detailsCartona = `          <div class="col-md-4">
    ...
    document.getElementById("detailsContent").innerHTML = detailsCartona;
  }
}
